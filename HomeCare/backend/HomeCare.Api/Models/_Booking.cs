 ...
 * Replaced with merged version in Booking.cs
 * Key difference: This uses Date + Time (string) while new
 * version uses DateTime DateTime property with BookingStatus enum
 * ============================================================
